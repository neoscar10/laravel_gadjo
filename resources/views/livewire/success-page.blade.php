    ...
    <div class="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto bg-white border rounded-md md:py-10 md:px-10">
      <div>
        ...
        <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200">
          ...
          <div class="w-full px-4 mb-4 md:w-1/4">
            <p class="mb-2 text-sm font-medium leading-5 text-gray-800  ">
              Total: </p>
            <p class="text-base font-semibold leading-4 text-orange-600 ">
            ...
            <div class="flex flex-col w-full px-2 space-y-4 md:px-8 ">
              ...
              <div class="flex items-start justify-between w-full">
                <div class="flex items-center justify-center space-x-2">
                  <div class="w-8 h-8">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-6 h-6 text-orange-600  bi bi-truck" viewBox="0 0 16 16">
        ...
        <div class="flex items-center justify-start gap-4 px-4 mt-6 ">
          <a href="/products" class="w-full text-center px-4 py-2 text-orange-500 border border-orange-500 rounded-md md:w-auto hover:text-white hover:bg-orange-600">
            Go back shopping
          </a>
          <a href="/my-orders" class="w-full text-center px-4 py-2 bg-orange-500 rounded-md text-gray-50 md:w-auto ">
            View My Orders
          </a>
        </div>
      </div>
